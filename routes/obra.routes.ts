...
api.get('/access', FILTRO_MIDDLEWARE.validarLimit, FILTRO_MIDDLEWARE.validarPage, FILTRO_MIDDLEWARE.validarFiltro, OBRA_INTERFACE.obtenerObrasAccess);
...
api.get('/sql', FILTRO_MIDDLEWARE.validarLimit, FILTRO_MIDDLEWARE.validarPage, FILTRO_MIDDLEWARE.validarFiltro, OBRA_INTERFACE.obtenerObrasSql);
